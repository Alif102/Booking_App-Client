...
const SignIn = () => {
  ...
  return (
    <div>
      <div className='text-cyan-500 p-5'>
          <h1>Admin - email : admin@1.com , pass : test123</h1>
          <h1>Host - email : host@1.com , pass : test123</h1>
          <h1>Guest - email : guest@1.com , pass : test123</h1>
        </div>
