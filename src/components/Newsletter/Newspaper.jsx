  ...
  return (
    <div className="w-10/12 md:w-9/12 mx-auto news-bg bg-no-repeat bg-cover bg-center mt-20 mb-36 rounded-2xl overflow-hidden">
      <div className="text-center text-white py-4">
        ...
        >
          <span className="text-cyan-500">Subscribe</span> our newsletter
        </h2>
        ...
        <div className="bg-transparent w-10/12 md:w-9/12 lg:w-6/12 mx-auto p-1 rounded-full overflow-hidden mt-8 mb-20 border border-gray-100">
          <form className="flex" data-aos="fade-up" data-aos-duration="1100">
            ...
            <input
              type="submit"
              className="w-4/12 bg-cyan-500 hover:bg-green-400 rounded-full text-gray-200 hover:text-gray-800 text-sm sm:text-base font-medium cursor-pointer"
            />
          </form>
        </div>
      </div>
