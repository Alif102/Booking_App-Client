    ...
    <div className="w-full mx-auto grid grid-cols-1 lg:grid-cols-2 bg-[#1f3347] my-32">
              ...
              >
                <div className="w-[60px] h-[60px] bg-[#fff] rounded-full">
                  ...
                  <span
                    ...
                    className="w-[60px] h-[60px] rounded-full absolute bg-[#fff] opacity-80"
                  ></span>
                  <div className="absolute right-0 left-1 top-0 bottom-0 flex items-center justify-center text-4xl cursor-pointer text-cyan-500 hover:text-green-400 transition-all duration-500">
      ...
      <div className="text-white p-12">
        ...
        >
          ...
          top-notch hospitality. Whether youre a weary traveler seeking a
          restful refuge or a discerning guest in search of opulence, we are
          here to exceed your expectations.
        </p>
        <button
          className="text-lg px-9 py-2.5 bg-cyan-500 mt-6 text-white"
          data-aos="fade-left"
